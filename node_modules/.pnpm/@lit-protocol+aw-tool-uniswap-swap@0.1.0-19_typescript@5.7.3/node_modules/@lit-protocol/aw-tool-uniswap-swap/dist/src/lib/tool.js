 ...
 * @type {z.ZodObject}
 */
const UniswapSwapLitActionSchema = zod_1.z.object({
 ...
 */
const validateUniswapSwapParameters = (params) => {
...
const createNetworkTool = (network, config) => ({
    ...
    policy: policy_1.UniswapSwapPolicy,
});
/**
 ...
 */
exports.UniswapSwap = Object.entries(aw_tool_1.NETWORK_CONFIGS).reduce((acc, [network, config]) => ({
    ...acc,
