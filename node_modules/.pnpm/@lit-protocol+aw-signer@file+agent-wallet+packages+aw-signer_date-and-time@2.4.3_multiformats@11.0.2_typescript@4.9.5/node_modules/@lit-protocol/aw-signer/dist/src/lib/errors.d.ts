 ...
 */
export declare enum AwSignerErrorType {
 ...
 */
export declare class AwSignerError extends Error {
    readonly type: AwSignerErrorType;
     ...
     */
    constructor(type: AwSignerErrorType, message: string, details?: Record<string, ErrorDetails | unknown> | undefined);
    /**
