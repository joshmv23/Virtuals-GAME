 ...
 */
export declare const fetchToolPolicyFromRegistry: (pkpToolRegistryContract: any, pkpTokenId: string, delegateeAddress: string, toolIpfsCid: string) => Promise<any>;
//# sourceMappingURL=fetch-tool-policy-from-registry.d.ts.map