...
export declare enum PermitToolErrors {
...
export declare enum RemoveToolPolicyParameterErrors {
    NO_TOOLS_WITH_POLICIES = "NO_TOOLS_WITH_POLICIES",
    NO_DELEGATEES = "NO_DELEGATEES",
    NO_PARAMETERS = "NO_PARAMETERS",
...
export declare enum DelegateeErrors {
...
export type LawCliErrorType = GetLitNetworkErrors | GeneralErrors | MainMenuErrors | CliSettingsMenuErrors | ChangeLitNetworkErrors | ManageRpcsMenuErrors | AddRpcErrors | EditRpcErrors | RemoveRpcErrors | AdminErrors | PermitToolErrors | RemoveToolErrors | EnableToolErrors | DisableToolErrors | ManagePoliciesMenuErrors | SetPolicyErrors | RemovePolicyErrors | EnablePolicyErrors | DisablePolicyErrors | GetToolPolicyErrors | GetDelegateesErrors | AddDelegateeErrors | RemoveDelegateeErrors | IsDelegateeErrors | ManageDelegateesMenuErrors | PermitToolForDelegateeErrors | UnpermitToolForDelegateeErrors | GetToolPolicyParameterErrors | SetToolPolicyParameterErrors | RemoveToolPolicyParameterErrors | DelegateeErrors;
