 ...
 */
async function getTokenInfo(provider, tokenIn, amountIn, tokenOut, pkp) {
    ...
    const tokenInContract = new ethers.Contract(params.tokenIn, tokenInterface, provider);
    const tokenOutContract = new ethers.Contract(params.tokenOut, tokenInterface, provider);
    // Parallel calls
    ...
    console.log('Token balances (in/out):', balanceIn.toString(), balanceOut.toString());
