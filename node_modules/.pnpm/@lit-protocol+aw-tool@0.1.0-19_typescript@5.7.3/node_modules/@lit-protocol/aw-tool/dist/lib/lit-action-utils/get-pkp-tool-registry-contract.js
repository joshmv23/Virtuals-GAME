...
exports.getPkpToolRegistryContract = void 0;
/**
 ...
 */
const getPkpToolRegistryContract = async (pkpToolRegistryAddress) => {
    ...
    return new ethers.Contract(pkpToolRegistryAddress, PKP_TOOL_REGISTRY_ABI, new ethers.providers.JsonRpcProvider(await Lit.Actions.getRpcUrl({
        chain: 'yellowstone',
    })));
};
