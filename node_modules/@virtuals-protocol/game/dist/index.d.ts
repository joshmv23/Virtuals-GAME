...
declare class GameAgent implements IGameAgent {
    ...
    static load(apiKey: string, name: string, goal: string, description: string, savedState: Record<string, any>, workers: GameWorker[]): Promise<GameAgent>;
}

export { ExecutableGameFunctionResponse, ExecutableGameFunctionStatus, GameAgent, GameFunction, GameWorker, LLMModel };
