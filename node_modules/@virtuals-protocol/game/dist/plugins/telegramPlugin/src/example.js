 ...
 */
const autoReplyAgent = new game_1.GameAgent("<API_TOKEN>", {
    name: "Telegram Bot",
 ...
 */
const financialAdvisorAgent = new game_1.GameAgent("<API_TOKEN>", {
 ...
 */
const nutritionistAgent = new game_1.GameAgent("<API_TOKEN>", {
