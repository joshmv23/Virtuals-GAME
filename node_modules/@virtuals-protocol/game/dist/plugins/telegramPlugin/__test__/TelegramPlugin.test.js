...
const telegramPlugin_1 = __importDefault(require("../src/telegramPlugin"));
...
describe("TelegramPlugin sendMessageFunction", () => {
    it("should send a message successfully when valid arguments are passed", () => __awaiter(void 0, void 0, void 0, function* () {
        // Arrange
        const taskArgs = { chat_id: "811200161", text: "hi, bot what your name" };
        const logger = jest.fn();
        // Act
        const result = yield telegramPlugin.sendMessageFunction.executable(taskArgs, logger);
        // Assert
    ...
    it("should send a message failed when missing arguments are passed", () => __awaiter(void 0, void 0, void 0, function* () {
        // Arrange
...
describe("TelegramPlugin sendMediaFunction", () => {
    it("should send a photo successfully when valid arguments are passed", () => __awaiter(void 0, void 0, void 0, function* () {
        // Arrange
        const taskArgs = {
            chat_id: "811200161",
            media_type: "photo",
        ...
        const logger = jest.fn();
        // Act
        const result = yield telegramPlugin.sendMediaFunction.executable(taskArgs, logger);
        // Assert
        expect(result.status).toBe(game_1.ExecutableGameFunctionStatus.Done);
        expect(logger).toHaveBeenNthCalledWith(1, "Sending photo media to chat: 811200161");
    }));
    it("should send a document successfully when valid arguments are passed", () => __awaiter(void 0, void 0, void 0, function* () {
        // Arrange
        const taskArgs = {
            chat_id: "811200161",
            media_type: "document",
    ...
    it("should send a video successfully when valid arguments are passed", () => __awaiter(void 0, void 0, void 0, function* () {
        // Arrange
        const taskArgs = {
            chat_id: "811200161",
            media_type: "video",
    ...
    it("should send a audio successfully when valid arguments are passed", () => __awaiter(void 0, void 0, void 0, function* () {
        // Arrange
        const taskArgs = {
            chat_id: "811200161",
            media_type: "audio",
    ...
    it("should send a photo failed when missing arguments are passed", () => __awaiter(void 0, void 0, void 0, function* () {
        // Arrange
        const taskArgs = {
            chat_id: "811200161",
            media: "https://example.com/image.jpg",
...
describe("TelegramPlugin createPollFunction", () => {
    it("should create an interactive poll successfully when valid arguments are passed", () => __awaiter(void 0, void 0, void 0, function* () {
        // Arrange
        ...
        const logger = jest.fn();
        // Act
        const result = yield telegramPlugin.createPollFunction.executable(taskArgs, logger);
        // Assert
        expect(result.status).toBe(game_1.ExecutableGameFunctionStatus.Done);
    ...
    it("should failed to create an interactive poll when missing arguments are passed", () => __awaiter(void 0, void 0, void 0, function* () {
        // Arrange
        const taskArgs = {
            chat_id: "811200161",
            question: "What is your favorite color?",
...
describe("TelegramPlugin pinnedMessageFunction", () => {
    it("should pin an important message in a chat successfully when valid arguments are passed", () => __awaiter(void 0, void 0, void 0, function* () {
        // Arrange
        const taskArgs = {
            chat_id: "811200161",
        ...
        const logger = jest.fn();
        // Act
        const result = yield telegramPlugin.pinnedMessageFunction.executable(taskArgs, logger);
        // Assert
        expect(result.status).toBe(game_1.ExecutableGameFunctionStatus.Done);
    ...
    it("should failed to pin an important message in a chat when missing arguments are passed", () => __awaiter(void 0, void 0, void 0, function* () {
        // Arrange
        const taskArgs = {
            chat_id: "811200161",
        };
...
describe("TelegramPlugin unPinnedMessageFunction", () => {
    it("should unpin an important message in a chat successfully when valid arguments are passed", () => __awaiter(void 0, void 0, void 0, function* () {
        // Arrange
        const taskArgs = {
            chat_id: "811200161",
            message_id: "123456789"
        ...
        const logger = jest.fn();
        // Act
        const result = yield telegramPlugin.unPinnedMessageFunction.executable(taskArgs, logger);
        // Assert
        expect(result.status).toBe(game_1.ExecutableGameFunctionStatus.Done);
    ...
    it("should failed to unpin an important message in a chat when missing arguments are passed", () => __awaiter(void 0, void 0, void 0, function* () {
        // Arrange
        const taskArgs = {
            chat_id: "811200161",
        };
...
describe("TelegramPlugin deleteMessageFunction", () => {
    it("should delete message from a chat successfully when valid arguments are passed", () => __awaiter(void 0, void 0, void 0, function* () {
        // Arrange
        const taskArgs = {
            chat_id: "811200161",
            message_id: "123456789"
        ...
        const logger = jest.fn();
        // Act
        const result = yield telegramPlugin.deleteMessageFunction.executable(taskArgs, logger);
        // Assert
        expect(result.status).toBe(game_1.ExecutableGameFunctionStatus.Done);
    ...
    it("should failed to delete message from a chat when missing arguments are passed", () => __awaiter(void 0, void 0, void 0, function* () {
        // Arrange
        const taskArgs = {
            chat_id: "811200161",
        };
