...
class Delegatee {
    ...
    static async create(delegateePrivateKey, { litNetwork, debug = false } = {}) {
        ...
        const toolPolicyRegistryConfig = aw_contracts_sdk_1.DEFAULT_REGISTRY_CONFIG[litNetwork];
        ...
        return new Delegatee(litNetwork, storage, litNodeClient, litContracts, (0, aw_contracts_sdk_1.getPkpToolRegistryContract)(toolPolicyRegistryConfig, delegateeWallet), delegateeWallet);
    }
    /**
    ...
    async getPermittedToolsForPkp(pkpTokenId) {
        ...
        return (0, aw_contracts_sdk_1.getPermittedToolsForDelegatee)(this.toolRegistryContract, pkpTokenId, this.delegateeWallet.address);
    }
    /**
