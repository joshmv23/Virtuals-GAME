...
async function exportPrivateKey(params) {
    ...
    const { litActionCode, litActionIpfsCid } = (0, utils_2.getLitActionCodeOrCid)(network, 'exportPrivateKey');
    return (0, lit_actions_client_1.exportPrivateKeyWithLitAction)({
        ...params,
