 ...
 *
 */
export type StoreEncryptedKeyParams = BaseApiParams & Pick<StoredKeyData, 'publicKey' | 'keyType' | 'dataToEncryptHash' | 'ciphertext' | 'memo'>;
...
export interface BatchGeneratePrivateKeysActionResult {
    generateEncryptedPrivateKey: GeneratePrivateKeyResult & {
        memo: string;
    };
    signMessage?: {
        signature: string;
 ...
 * @property { string } memo A (typically) user-provided descriptor for the encrypted private key
 */
export type GeneratePrivateKeyParams = BaseApiParams & ApiParamsSupportedNetworks & {
    memo: string;
};
 ...
 */
export type SignMessageWithEncryptedKeyParams = BaseApiParams & ApiParamsSupportedNetworks & SignMessageParams;
 ...
 */
export type SignTransactionWithEncryptedKeyParams = SignTransactionParamsSupportedEvm | SignTransactionParamsSupportedSolana;
export {};
