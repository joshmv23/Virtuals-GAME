...
export type LitActionType = 'signTransaction' | 'signMessage' | 'generateEncryptedKey' | 'exportPrivateKey';
...
export type LitCidRepositoryCommon = Readonly<Record<LitActionTypeCommon, string>>;
/**
...
export type LitActionCodeRepositoryEntryInput = Partial<LitActionCodeRepositoryEntry>;
/**
 ...
 */
export type LitActionCodeRepository = Readonly<Record<LitActionType, LitActionCodeRepositoryEntry>>;
export type LitActionCodeRepositoryInput = Partial<Record<LitActionType, LitActionCodeRepositoryEntryInput>>;
export type LitActionCodeRepositoryCommon = Record<LitActionTypeCommon, string>;
export type LitActionCodeRepositoryCommonInput = Partial<Record<LitActionTypeCommon, string>>;
