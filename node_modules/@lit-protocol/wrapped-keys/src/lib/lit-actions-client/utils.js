...
exports.postLitActionValidation = postLitActionValidation;
...
exports.getLitActionCodeOrCidCommon = getLitActionCodeOrCidCommon;
exports.getLitActionCidCommon = getLitActionCidCommon;
exports.getLitActionCodeCommon = getLitActionCodeCommon;
 ...
 * @returns {{ litActionCode?: string, litActionIpfsCid?: string }} The Lit action code or its IPFS CID.
 */
function getLitActionCodeOrCidCommon(actionType) {
    // Default state is that litActionCode will be falsy, unless someone has injected to it using `setLitActionsCode();
...
function getLitActionCidCommon(actionType) {
    return constants_1.LIT_ACTION_CID_REPOSITORY_COMMON[actionType];
}
function getLitActionCodeCommon(actionType) {
    // No fuzzy validation needed here, because `setLitActionsCodeCommon()` validates its input
    return code_repository_1.litActionCodeRepositoryCommon[actionType];
}
