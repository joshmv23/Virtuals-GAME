  ...
  var init_get_pkp_info = __esm({
    "../aw-tool/src/lib/lit-action-utils/get-pkp-info.ts"() {
      ...
      getPkpInfo = async (pkpEthAddress) => {
        ...
        const networkConfig = NETWORK_CONFIG["datil"];
        if (!networkConfig) {
          throw new Error(`Unsupported Lit network: ${"datil"}`);
        }
...
` + maybeLogsOutput + guideText;
  ...
  async function createSolanaKeypair(pkpTokenId) {
    const accessControlConditions = getAccessControlConditions(pkpTokenId, "datil");
  ...
  var require_tool = __commonJS({
    "src/lib/lit-actions/tool.ts"() {
      ...
      (async () => {
        try {
          console.log(`Using Lit Network: ${"datil"}`);
          console.log(
            `Using PKP Tool Registry Address: ${"0xBDEd44A02b64416C831A0D82a630488A854ab4b1"}`
          );
          console.log(
            `Using Pubkey Router Address: ${NETWORK_CONFIG["datil"].pubkeyRouterAddress}`
          );
          ...
          const pkpToolRegistryContract = await getPkpToolRegistryContract(
            "0xBDEd44A02b64416C831A0D82a630488A854ab4b1"
          );
          ...
          if (toolPolicy.enabled && toolPolicy.policyIpfsCid !== void 0 && toolPolicy.policyIpfsCid !== "0x" && toolPolicy.policyIpfsCid !== "") {
            ...
            await Lit.Actions.call({
              ...
              params: {
                ...
                pkpToolRegistryContractAddress: "0xBDEd44A02b64416C831A0D82a630488A854ab4b1",
