...
var LitAction = (() => {
  ...
  var init_get_pkp_info = __esm({
    "../aw-tool/src/lib/lit-action-utils/get-pkp-info.ts"() {
      ...
      getPkpInfo = async (pkpEthAddress) => {
        ...
        const networkConfig = NETWORK_CONFIG["datil-test"];
        if (!networkConfig) {
          throw new Error(`Unsupported Lit network: ${"datil-test"}`);
        }
        ...
        const publicKey2 = await pubkeyRouter.getPubkey(pkpTokenId);
        console.log(`Got public key: ${publicKey2}`);
        return {
  ...
  var require_generateRequest = __commonJS({
    "../../node_modules/.pnpm/jayson@4.1.3_bufferutil@4.0.9_utf-8-validate@5.0.10/node_modules/jayson/lib/generateRequest.js"(exports, module) {
      ...
      var generateRequest = function(method, params2, id, options) {
        ...
        if (params2) {
          if (typeof params2 !== "object" && !Array.isArray(params2)) {
            throw new TypeError(params2 + " must be an object, array or omitted");
          }
  ...
  var require_browser2 = __commonJS({
    "../../node_modules/.pnpm/jayson@4.1.3_bufferutil@4.0.9_utf-8-validate@5.0.10/node_modules/jayson/lib/client/browser/index.js"(exports, module) {
      ...
      ClientBrowser.prototype.request = function(method, params2, id, callback) {
        const self = this;
        let request = null;
        const isBatch = Array.isArray(method) && typeof params2 === "function";
        if (this.options.version === 1 && isBatch) {
          throw new TypeError("JSON-RPC 1.0 does not support batching");
        }
        const isRaw = !isBatch && method && typeof method === "object" && typeof params2 === "function";
        if (isBatch || isRaw) {
          callback = params2;
          request = method;
        } else {
          ...
          try {
            request = generateRequest(method, params2, id, {
  ...
  var init_index_browser = __esm({
    "../../node_modules/.pnpm/rpc-websockets@9.0.4/node_modules/rpc-websockets/dist/index.browser.mjs"() {
      ...
      CommonClient = class extends import_index.default {
        ...
        * @return {Promise}
        */
        call(method, params2, timeout, ws_opts) {
          ...
          return new Promise((resolve, reject) => {
            ...
            const rpc_id = this.generate_request_id(method, params2);
            const message = {
              jsonrpc: "2.0",
              method,
              params: params2 || void 0,
              id: rpc_id
            };
        ...
        */
        async login(params2) {
          const resp = await this.call("rpc.login", params2);
          if (!resp)
    ...
    return (requests) => {
      return new Promise((resolve, reject) => {
        if (requests.length === 0)
          resolve([]);
        const batch = requests.map((params2) => {
          return client.request(params2.methodName, params2.args);
        });
...
` + maybeLogsOutput + guideText;
      ...
      SystemProgram = class _SystemProgram {
         ...
         */
        static createAccount(params2) {
          const type2 = SYSTEM_INSTRUCTION_LAYOUTS.Create;
          const data = encodeData(type2, {
            lamports: params2.lamports,
            space: params2.space,
            programId: toBuffer(params2.programId.toBuffer())
          });
          return new TransactionInstruction({
            keys: [{
              pubkey: params2.fromPubkey,
              isSigner: true,
              isWritable: true
            }, {
              pubkey: params2.newAccountPubkey,
              isSigner: true,
              isWritable: true
            }],
         ...
         */
        static transfer(params2) {
          let data;
          let keys;
          if ("basePubkey" in params2) {
            const type2 = SYSTEM_INSTRUCTION_LAYOUTS.TransferWithSeed;
            data = encodeData(type2, {
              lamports: BigInt(params2.lamports),
              seed: params2.seed,
              programId: toBuffer(params2.programId.toBuffer())
            });
            keys = [{
              ...
              pubkey: params2.basePubkey,
              isSigner: true,
              isWritable: false
            }, {
              pubkey: params2.toPubkey,
              isSigner: false,
              isWritable: true
            }];
          } else {
         ...
         */
        static assign(params2) {
          let data;
          let keys;
          if ("basePubkey" in params2) {
            const type2 = SYSTEM_INSTRUCTION_LAYOUTS.AssignWithSeed;
            data = encodeData(type2, {
              base: toBuffer(params2.basePubkey.toBuffer()),
              seed: params2.seed,
              programId: toBuffer(params2.programId.toBuffer())
            });
            keys = [{
              pubkey: params2.accountPubkey,
              isSigner: false,
              isWritable: true
            }, {
              pubkey: params2.basePubkey,
         ...
         */
        static createAccountWithSeed(params2) {
          ...
          if (!params2.basePubkey.equals(params2.fromPubkey)) {
            keys.push({
              pubkey: params2.basePubkey,
              isSigner: true,
              isWritable: false
         ...
         */
        static createNonceAccount(params2) {
          const transaction = new Transaction();
          if ("basePubkey" in params2 && "seed" in params2) {
            transaction.add(_SystemProgram.createAccountWithSeed({
              fromPubkey: params2.fromPubkey,
              newAccountPubkey: params2.noncePubkey,
              basePubkey: params2.basePubkey,
              seed: params2.seed,
              lamports: params2.lamports,
          ...
          const initParams = {
            noncePubkey: params2.noncePubkey,
            authorizedPubkey: params2.authorizedPubkey
          };
         ...
         */
        static nonceInitialize(params2) {
          const type2 = SYSTEM_INSTRUCTION_LAYOUTS.InitializeNonceAccount;
          const data = encodeData(type2, {
            authorized: toBuffer(params2.authorizedPubkey.toBuffer())
          });
          const instructionData = {
            keys: [{
              pubkey: params2.noncePubkey,
              isSigner: false,
              isWritable: true
            }, {
        ...
        static nonceAdvance(params2) {
          ...
          const instructionData = {
            keys: [{
              ...
              pubkey: params2.authorizedPubkey,
              isSigner: true,
              isWritable: false
            }],
            programId: this.programId,
         ...
         * on a Nonce account.
         */
        static nonceAuthorize(params2) {
          const type2 = SYSTEM_INSTRUCTION_LAYOUTS.AuthorizeNonceAccount;
          const data = encodeData(type2, {
            authorized: toBuffer(params2.newAuthorizedPubkey.toBuffer())
          });
          return new TransactionInstruction({
            keys: [{
              pubkey: params2.noncePubkey,
      ...
      Connection = class {
        ...
        async getSignatureStatuses(signatures, config) {
          const params2 = [signatures];
          if (config) {
            params2.push(config);
          }
          const unsafeRes = await this._rpcRequest("getSignatureStatuses", params2);
      ...
      AddressLookupTableProgram = class {
        ...
        static createLookupTable(params2) {
          const [lookupTableAddress, bumpSeed] = PublicKey.findProgramAddressSync([params2.authority.toBuffer(), (0, import_bigint_buffer.toBufferLE)(BigInt(params2.recentSlot), 8)], this.programId);
          const type2 = LOOKUP_TABLE_INSTRUCTION_LAYOUTS.CreateLookupTable;
          const data = encodeData(type2, {
            recentSlot: BigInt(params2.recentSlot),
            bumpSeed
          });
          const keys = [{
            ...
            pubkey: params2.authority,
            isSigner: true,
            isWritable: false
          }, {
            pubkey: params2.payer,
            isSigner: true,
            isWritable: true
          }, {
        ...
        static extendLookupTable(params2) {
          const type2 = LOOKUP_TABLE_INSTRUCTION_LAYOUTS.ExtendLookupTable;
          const data = encodeData(type2, {
            addresses: params2.addresses.map((addr) => addr.toBytes())
          });
          const keys = [{
            pubkey: params2.lookupTable,
            isSigner: false,
        ...
        static deactivateLookupTable(params2) {
        ...
        static closeLookupTable(params2) {
      ...
      ComputeBudgetProgram = class {
         ...
         */
        static requestUnits(params2) {
          const type2 = COMPUTE_BUDGET_INSTRUCTION_LAYOUTS.RequestUnits;
          const data = encodeData(type2, params2);
          return new TransactionInstruction({
            keys: [],
            programId: this.programId,
            data
        ...
        static requestHeapFrame(params2) {
        ...
        static setComputeUnitLimit(params2) {
        ...
        static setComputeUnitPrice(params2) {
          const type2 = COMPUTE_BUDGET_INSTRUCTION_LAYOUTS.SetComputeUnitPrice;
          const data = encodeData(type2, {
            microLamports: BigInt(params2.microLamports)
          });
          return new TransactionInstruction({
            keys: [],
            programId: this.programId,
      ...
      Ed25519Program = class _Ed25519Program {
         ...
         */
        static createInstructionWithPublicKey(params2) {
          const {
            publicKey: publicKey2,
            message,
            signature: signature2,
         ...
         */
        static createInstructionWithPrivateKey(params2) {
          const {
            privateKey,
            message,
            instructionIndex
      ...
      Secp256k1Program = class _Secp256k1Program {
         ...
         */
        static createInstructionWithEthAddress(params2) {
          const {
      ...
      StakeProgram = class {
        ...
        static createAccountWithSeed(params2) {
          ...
          transaction.add(SystemProgram.createAccountWithSeed({
            fromPubkey: params2.fromPubkey,
            newAccountPubkey: params2.stakePubkey,
            basePubkey: params2.basePubkey,
            seed: params2.seed,
            lamports: params2.lamports,
            space: this.space,
         ...
         * or Withdrawer on the Stake account.
         */
        static authorizeWithSeed(params2) {
          const {
            stakePubkey,
            authorityBase,
            authoritySeed,
         ...
         * @internal
         */
        static splitInstruction(params2) {
          const {
            stakePubkey,
            authorizedPubkey,
            splitStakePubkey,
         ...
         */
        static split(params2, rentExemptReserve) {
          const transaction = new Transaction();
          transaction.add(SystemProgram.createAccount({
            fromPubkey: params2.authorizedPubkey,
            newAccountPubkey: params2.splitStakePubkey,
            lamports: rentExemptReserve,
            space: this.space,
            programId: this.programId
          }));
          return transaction.add(this.splitInstruction(params2));
        }
        /**
         * Generate a Transaction that splits Stake tokens into another account
         * derived from a base public key and seed
         */
        static splitWithSeed(params2, rentExemptReserve) {
          const {
            stakePubkey,
            authorizedPubkey,
            splitStakePubkey,
      ...
      VoteProgram = class _VoteProgram {
         ...
         */
        static initializeAccount(params2) {
          const {
            votePubkey,
            nodePubkey,
            voteInit: voteInit2
        ...
        static createAccount(params2) {
          ...
          transaction.add(SystemProgram.createAccount({
            fromPubkey: params2.fromPubkey,
            newAccountPubkey: params2.votePubkey,
            lamports: params2.lamports,
            space: this.space,
            programId: this.programId
          }));
          return transaction.add(this.initializeAccount({
            votePubkey: params2.votePubkey,
            nodePubkey: params2.voteInit.nodePubkey,
            voteInit: params2.voteInit
          }));
        }
        /**
         ...
         */
        static safeWithdraw(params2, currentVoteAccountBalance, rentExemptMinimum) {
          if (params2.lamports > currentVoteAccountBalance - rentExemptMinimum) {
            throw new Error("Withdraw will leave vote account with insufficient funds.");
          }
          return _VoteProgram.withdraw(params2);
        }
        /**
         * Generate a transaction to update the validator identity (node pubkey) of a Vote account.
         */
        static updateValidatorIdentity(params2) {
          const {
            votePubkey,
            authorizedWithdrawerPubkey,
            nodePubkey
  ...
  // src/lib/lit-actions/utils/solana-keypair.ts
  async function createSolanaKeypair(pkpTokenId) {
    const accessControlConditions = getAccessControlConditions(pkpTokenId, "datil-test");
  ...
  // src/lib/lit-actions/utils/solana-connection.ts
  function createSolanaConnection(endpoint = "https://api.mainnet-beta.solana.com") {
    return new Connection(endpoint, {
      commitment: "confirmed",
      confirmTransactionInitialTimeout: 1e4
    });
  }
  var init_solana_connection = __esm({
    "src/lib/lit-actions/utils/solana-connection.ts"() {
      "use strict";
      init_index_browser_esm();
    }
  ...
  // src/lib/lit-actions/utils/token-decimals.ts
  ...
  // src/lib/lit-actions/utils/atomic-conversion.ts
  ...
  var init_atomic_conversion = __esm({
    "src/lib/lit-actions/utils/atomic-conversion.ts"() {
      "use strict";
    }
  });

  // src/lib/lit-actions/utils/quote.ts
  ...
  // src/lib/lit-actions/utils/swap.ts
  async function getJupiterSwapTransaction({
    ...
    const swapTransactionBuf = Uint8Array.from(
      atob(swapTransaction).split("").map((c) => c.charCodeAt(0))
    );
  ...
  // src/lib/lit-actions/utils/transaction.ts
    ...
    const txid = await Lit.Actions.runOnce(
      ...
      async () => {
        ...
        try {
          ...
          console.log("Inside runOnce: Transaction sent successfully:", signature2);
          return signature2;
        } catch (error) {
  ...
  // src/lib/lit-actions/utils/index.ts
  var init_utils3 = __esm({
    "src/lib/lit-actions/utils/index.ts"() {
      "use strict";
      init_solana_keypair();
      init_solana_connection();
      init_token_decimals();
      init_atomic_conversion();
      init_quote();
      init_swap();
      init_transaction();
    }
  ...
  var require_tool = __commonJS({
    "src/lib/lit-actions/tool.ts"() {
      ...
      (async () => {
        try {
          console.log(`Using Lit Network: ${"datil-test"}`);
          console.log(
            `Using PKP Tool Registry Address: ${"0x525bF2bEb622D7C05E979a8b3fFcDBBEF944450E"}`
          );
          console.log(
            `Using Pubkey Router Address: ${NETWORK_CONFIG["datil-test"].pubkeyRouterAddress}`
          );
          ...
          const pkpToolRegistryContract = await getPkpToolRegistryContract(
            "0x525bF2bEb622D7C05E979a8b3fFcDBBEF944450E"
          );
          ...
          if (toolPolicy.enabled && toolPolicy.policyIpfsCid !== void 0 && toolPolicy.policyIpfsCid !== "0x" && toolPolicy.policyIpfsCid !== "") {
            ...
            await Lit.Actions.call({
              ...
              params: {
                ...
                pkpToolRegistryContractAddress: "0x525bF2bEb622D7C05E979a8b3fFcDBBEF944450E",
